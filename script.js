...
function initPage() {
  ...
  // Add this to the initPage function, right after renderResume("en")
  function ensureSocialIconsVisible() {
  ...
  // Call this function after a short delay to ensure DOM is ready
  setTimeout(ensureSocialIconsVisible, 500)
